---
title: "Keystore and Truststore Configuration"
description: "How to create, configure, and manage keystores and truststores for secure production deployments with WSO2 Integrator: BI."
---

# Keystore and Truststore Configuration

Keystores and truststores are foundational to securing communication in production deployments. This guide explains what each is, how to create them, and how to configure them in WSO2 Integrator: BI.
...
```toml
keystorePath = "/opt/myservice/security/keystore.p12"
keystorePassword = "<keystore-password>"
truststorePath = "/opt/myservice/security/truststore.p12"
...
- [Strengthen TLS Security](/deploy/deployment-best-practices/runtime-security#strengthen-tls-security)
- [Manage Secrets Securely](/deploy/deployment-best-practices/runtime-security#manage-secrets-securely)
